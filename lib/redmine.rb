...
Redmine::MenuManager.map :top_menu do |menu|
  menu.push :my_page, { :controller => '/my', :action => 'page' }, :html => {:class => 'icon icon-user1'}, :if => Proc.new { User.current.logged? }
  ...
  menu.push :help, OpenProject::Info.help_url, :last => true, :caption => I18n.t('label_help'), :html => { :accesskey => OpenProject::AccessKeys.key_for(:help), :class => "icon icon-help"}
end
