...
Redmine::MenuManager.map :top_menu do |menu|
  menu.push :my_page, { :controller => '/my', :action => 'page' }, :html => {:'data-icon' => "&#xe0aa;".html_safe}, :if => Proc.new { User.current.logged? }
  ...
  menu.push :help, OpenProject::Info.help_url, :last => true, :caption => I18n.t('label_help'), :html => { :accesskey => OpenProject::AccessKeys.key_for(:help), :'data-icon' => "&#xe017;".html_safe}
end
...
Redmine::MenuManager.map :my_menu do |menu|
  menu.push :account, {:controller => '/my', :action => 'account'}, :caption => :label_my_account, :html => {:'data-icon2' => "&#xe0bc;".html_safe}
  menu.push :password, {:controller => '/my', :action => 'password'}, :caption => :button_change_password, :if => Proc.new { User.current.change_password_allowed? }, :html => {:'data-icon2' => "&#xe077;".html_safe}
...
Redmine::MenuManager.map :admin_menu do |menu|
  menu.push :projects, {:controller => '/admin', :action => 'projects'}, :caption => :label_project_plural, :html => {:'data-icon2' => "&#xe07b;".html_safe}
  menu.push :users, {:controller => '/users'}, :caption => :label_user_plural, :html => {:'data-icon2' => "&#xe0bc;".html_safe}
  menu.push :groups, {:controller => '/groups'}, :caption => :label_group_plural, :html => {:'data-icon2' => "&#xe018;".html_safe}
  menu.push :roles, {:controller => '/roles'}, :caption => :label_role_and_permissions, :html => {:'data-icon2' => "&#xe020;".html_safe}
  menu.push :types, {:controller => '/types'}, :caption => :label_type_plural, :html => {:'data-icon2' => "&#xe026;".html_safe}
  menu.push :statuses, {:controller => '/statuses'}, :caption => :label_work_package_status_plural,
            :html => {:class => 'statuses', :'data-icon2' => "&#xe020;".html_safe}
  menu.push :workflows, {:controller => '/workflows', :action => 'edit'}, :caption => Proc.new { Workflow.model_name.human }, :html => {:'data-icon2' => "&#xe020;".html_safe}
  menu.push :custom_fields, {:controller => '/custom_fields'},  :caption => :label_custom_field_plural,
            :html => {:class => 'custom_fields', :'data-icon2' => "&#xe020;".html_safe}
  menu.push :enumerations, {:controller => '/enumerations'}, :html => {:'data-icon2' => "&#xe020;".html_safe}
  menu.push :settings, {:controller => '/settings'}, :html => {:'data-icon2' => "&#xe09e;".html_safe}
  menu.push :ldap_authentication, {:controller => '/ldap_auth_sources', :action => 'index'},
            :html => {:class => 'server_authentication', :'data-icon2' => "&#xe020;".html_safe}
  menu.push :plugins, {:controller => '/admin', :action => 'plugins'}, :last => true, :html => {:'data-icon2' => "&#xe020;".html_safe}
  menu.push :info, {:controller => '/admin', :action => 'info'}, :caption => :label_information_plural, :last => true, :html => {:'data-icon2' => "&#xe049;".html_safe}
  menu.push :colors,
            {:controller => '/planning_element_type_colors', :action => 'index'},
            {:caption    => :'timelines.admin_menu.colors', :html => {:'data-icon2' => "&#xe020;".html_safe}}
  menu.push :project_types,
            {:controller => '/project_types', :action => 'index'},
            {:caption    => :'timelines.admin_menu.project_types', :html => {:'data-icon2' => "&#xe026;".html_safe}}
end
